  ...
  return (
    <div className="mb-1 text-center cursor-pointer grid grid-cols-6 border-b-[1px] border-r-[1px] border-[#2682d5]">
      ...
      <div
        ...
        className="py-2 bg-white text-3xl text-[#2682d5] border-l-[1px] border-t-[1px] border-[#2682d5] bg-[url(/mobile/icons/btn_arrowCRB.svg)] bg-[center] bg-[length:25px_86px] bg-no-repeat w-full h-full"></div>
      <div
